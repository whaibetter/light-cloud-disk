<template>
  <view class="page">
      ...
      <view class="mobile-header-content">
        <view class="mobile-logo">
          ...
          <view class="mobile-logo-text">
            <text class="mobile-app-name">
              轻量云盘
            </text>
            <text class="mobile-app-desc">
              {{ fileStore.files.length }} 个文件
            </text>
          </view>
        </view>
    ...
    <view class="mobile-content">
      <!-- 空状态 -->
      <view
        v-if="filteredFiles.length === 0 && !fileStore.loading"
        class="empty-state"
      >
      ...
      >
        ...
        >
          <view
            class="mobile-file-icon"
            :style="{ background: getFileGradient(file.mimetype) }"
          >
          ...
          <view class="mobile-file-info">
            ...
            <text class="mobile-file-meta">
              {{ formatSize(file.size) }} · {{ formatDate(file.uploadTime) }}
            </text>
          </view>
          <view class="mobile-file-actions">
            <view
              class="mobile-action-icon download"
              @click.stop="handleDownload(file)"
            >
              <text>↓</text>
            </view>
            <view
              class="mobile-action-icon delete"
    ...
    <view class="desktop-layout">
      ...
      <view class="main-content">
        ...
        <view class="files-area">
          ...
          <!-- 列表视图 -->
          <view
            v-if="viewMode === 'list' && filteredFiles.length > 0"
            class="list-view"
          >
            <view class="list-header">
              ...
              <text class="header-size">
                大小
              </text>
              <text class="header-time">
                修改时间
              </text>
              <text class="header-actions">
                操作
              </text>
            </view>
            <view
          ...
          <!-- 网格视图 -->
          <view
            v-if="viewMode === 'grid' && filteredFiles.length > 0"
            class="grid-view"
          >
            <view
              v-for="(file, index) in filteredFiles"
      ...
      >
        ...
        <view class="modal-body">
          ...
          >
            ...
            <text
              v-if="fileStore.sortBy === option.value"
              class="option-check"
            >
              ✓
            </text>
          </view>
          <view class="sort-divider" />
